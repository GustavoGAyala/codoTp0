# Del módulo flask importar la clase Flask y los métodos
jsonify,request
...
# Definir la tabla
class Producto(db.Model): # clase Producto hereda de db.Model
    ...
    def __init__(self,nombre,precio,stock,imagen):
        ...
        self.nombre=nombre
        # No hace falta el id porque lo crea sola mysql por ser
        #auto_incremento
        self.precio=precio
        self.stock=stock
        self.imagen=imagen
